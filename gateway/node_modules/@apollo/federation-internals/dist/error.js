...
const MAX_VALIDATION_SUBGRAPH_PATHS_EXCEEDED = makeCodeDefinition('MAX_VALIDATION_SUBGRAPH_PATHS_EXCEEDED', 'The maximum number of validation subgraph paths has been exceeded.', { addedIn: '2.8.0' });
const AUTH_REQUIREMENTS_APPLIED_ON_INTERFACE = makeCodeDefinition('AUTH_REQUIREMENTS_APPLIED_ON_INTERFACE', 'The @authenticated, @requiresScopes and @policy directive cannot be applied on interface, interface fields and interface object', { addedIn: '2.9.4' });
const MISSING_TRANSITIVE_AUTH_REQUIREMENTS = makeCodeDefinition('MISSING_TRANSITIVE_AUTH_REQUIREMENTS', 'Field missing transitive @authenticated, @requiresScopes and/or @policy auth requirements needed to access dependent data.', { addedIn: '2.9.4' });
